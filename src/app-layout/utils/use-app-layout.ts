...
import { AppLayoutInternalProps, AppLayoutProps, AppLayoutPropsWithDefaults } from '../interfaces';
...
export function useAppLayout({
  ...
  ...rest
}: AppLayoutPropsWithDefaults): readonly [ref: React.RefObject<HTMLElement>, props: AppLayoutInternalProps] {
