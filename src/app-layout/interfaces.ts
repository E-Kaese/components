...
export type AppLayoutInternalProps = SomeRequired<
  Omit<AppLayoutPropsWithDefaults, 'headerSelector' | 'footerSelector'>,
  'minContentWidth' | 'navigationOpen' | 'onNavigationChange'
> & {
