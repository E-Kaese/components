...
import ColumnDisplayProperties = TreeGridProps.ColumnDisplayProperties;
 ...
 * function type.
 */
export interface TreeGridForwardRefType {
  <T>(props: TreeGridProps<T> & { ref?: React.Ref<TreeGridProps.Ref> }): JSX.Element;
}

export interface TreeGridProps<T = any> extends BaseComponentProps {
  /**
   ...
   */
  trackBy?: TreeGridProps.TrackBy<T>;
   ...
   */
  selectionType?: TreeGridProps.SelectionType;
  /**
   ...
   */
  isItemDisabled?: TreeGridProps.IsItemDisabled<T>;
   ...
   */
  ariaLabels?: TreeGridProps.AriaLabels<T>;
   ...
   */
  sortingColumn?: TreeGridProps.SortingColumn<T>;
  /**
   ...
   *
   */
  stickyColumns?: TreeGridProps.StickyColumns;
   ...
   */
  onColumnWidthsChange?: NonCancelableEventHandler<TreeGridProps.ColumnWidthsChangeDetail>;
   ...
   */
  onSortingChange?: NonCancelableEventHandler<TreeGridProps.SortingState<T>>;
   ...
   */
  onSelectionChange?: NonCancelableEventHandler<TreeGridProps.SelectionChangeDetail<T>>;
   ...
   */
  onRowClick?: NonCancelableEventHandler<TreeGridProps.OnRowClickDetail<T>>;
   ...
   */
  onRowContextMenu?: CancelableEventHandler<TreeGridProps.OnRowContextMenuDetail<T>>;
   ...
   */
  renderAriaLive?: (data: TreeGridProps.LiveAnnouncement) => string;
  /**
   ...
   */
  submitEdit?: TreeGridProps.SubmitEditFunction<T>;
...
export namespace TreeGridProps {
  ...
  export interface EditConfig<T, V = any> {
     ...
     */
    editingCell(item: T, ctx: TreeGridProps.CellContext<any>): React.ReactNode;
  }
  ...
  export interface AriaLabels<T> {
    allItemsSelectionLabel?: (data: TreeGridProps.SelectionState<T>) => string;
    itemSelectionLabel?: (data: TreeGridProps.SelectionState<T>, row: T) => string;
