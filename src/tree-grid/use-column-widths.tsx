...
function checkProperty(column: TreeGridProps.ColumnDefinition<any>, name: 'width' | 'minWidth') {
...
export function checkColumnWidths(columnDefinitions: ReadonlyArray<TreeGridProps.ColumnDefinition<any>>) {
...
interface WidthProviderProps {
  ...
  visibleColumnDefinitions: ReadonlyArray<TreeGridProps.ColumnDefinition<any>>;
