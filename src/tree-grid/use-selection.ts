...
export function useFocusMove(selectionType: TreeGridProps['selectionType'], totalItems: number) {
...
class ItemSet<T> {
  constructor(trackBy: TreeGridProps.TrackBy<T> | undefined, items: ReadonlyArray<T>) {
    this.trackBy = trackBy;
    items.forEach(this.put);
  }
  private trackBy: TreeGridProps.TrackBy<T> | undefined;
