...
interface TableHeaderCellProps<ItemType> {
  ...
  tabIndex: number;
  column: TreeGridProps.ColumnDefinition<ItemType>;
  activeSortingColumn?: TreeGridProps.SortingColumn<ItemType>;
  sortingDescending?: boolean;
  sortingDisabled?: boolean;
  wrapLines?: boolean;
  hidden?: boolean;
  onClick(detail: TreeGridProps.SortingState<any>): void;
  onResizeFinish: () => void;
  colIndex: number;
