...
export interface FramePaginationProps {
   ...
   */
  onPreviousPageClick?: NonCancelableEventHandler<FramePaginationProps.PageClickDetail>;
   ...
   * * `requestedPageIndex` (integer) - The index of the requested page.
   */
  onNextPageClick?: NonCancelableEventHandler<FramePaginationProps.PageClickDetail>;
}
